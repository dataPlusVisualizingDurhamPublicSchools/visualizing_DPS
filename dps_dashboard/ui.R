    ...
    {tabItem(tabName = "home",
             ...
             fluidRow(
               ...
               box(title = strong(i18n$t("2 Universities, 52 Public Schools")),
                   solidHeader = TRUE,
                   width = 7,
                   p(i18n$t("The Durham Public School District has 54 public schools: 30 elementary, 9 middle, 2 secondary, 11 high, 1 alternative, and 1 hospital. Our project includes 29 elementary schools: C.C. Spaulding, Eastway, E.K. Powe, Fayetteville Street, Forest View, Lakewood, Parkwood, Southwest, Hillandale, Club Boulevard, Eno Valley, Glenn, Creekside, Easley, Burton, Bethesda, George Watts, Holt, Hope Valley, Little River K-8, Morehead Montessori Magnet, Merrick-Moore, Oak Grove, Pearsontown, W.G. Pearson, Sandy Ridge, R.N. Harris, Spring Valley, and Y.E. Smith; 9 middle schools: Lakewood Montessori, Lowes Grove, Brogden, Sherwood Githens, Lucas, Carrington, Neal, Rogers-Herr, and Shepard; 12 high schools: Hillside, C.E. Jordan, Riverside, Durham Performance Learning Center, City of Medicine Academy, J.D. Clement Early College, Durham School of Technology, Middle College, Holton Career and Resource Center, Northern, Southern, and Lakeview Secondary; and two 6-12 schools: Durham School of the Arts and The School for Creative Studies.")),
                   br(),
