...
sidebar <- {dashboardSidebar(
    ...
    sidebarMenu(
        ...
        menuItem("Report by School", tabName = "summary", icon = icon ("list-alt")),
    ...
    tabItems(
        ...
        {tabItem(tabName = "insightstab",
                 ...
                 fluidRow(
                   box(width  = 8,
                       solidHeader = TRUE,
                       title = strong("Comparing Resources Across School Zones"),
                       plotlyOutput("zones_barplots",
                                    width="auto",
                                    height = "auto")),
                   box(width  = 4,
                       solidHeader = TRUE,
                       title = strong("Differences Across School Zones"))
                 )
        )},
